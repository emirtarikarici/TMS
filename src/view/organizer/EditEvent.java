...
public class EditEvent extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EditEvent window = new EditEvent("Temp",0);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public EditEvent(String currentUsername, int eventId) {
    ...
    private void initialize() {
        ...
        frame = new JFrame("Edit Event Page");
        ...
        editButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(!nameTextField.getText().isEmpty() &&
                    ...
                    frame.dispose();
                    eventController.updateEvent(eventId,nameTextField.getText(), currentUsername, eventDate, locationTextField.getText(), Integer.parseInt(capacityTextField.getText()), Double.parseDouble(priceTextField.getText()));
        ...
        cancelButton.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                frame.dispose();
                OrganizerEditEvent userMainPage = new OrganizerEditEvent(currentUsername);
            }
        });
